        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="itemise_inner">
                    <a href="" class="logout_action"><i class="fas fa-power-off"></i> Logout</a>
                                ...
                                <div class="col-md-12">
                                    <ul id="tabs" class="nav nav-tabs nav-justified">
                                        <li class="nav-item"><a href="" data-target="#home1" data-toggle="tab"
                                                                class="nav-link small text-uppercase  active">Profile</a>
                                        </li>
                                        ...
                                        <li class="nav-item"><a href="" data-target="#people" data-toggle="tab"
                                                                class="nav-link small text-uppercase">People ( 20 )</a>
                                        </li>
                                    </ul>
                                    <br>
                                    <div id="tabsContent" class="tab-content">
                                        <div id="home1" class="tab-pane fade  active show">
                                            <div class="list-group">
                                                <a href="" class="list-group-item d-inline-block"><span
                                                        class="float-right badge badge-pill badge-dark">51</span>Followers
                                                </a>
                                                <a href="" class="list-group-item d-inline-block"><span
                                                        class="float-right badge badge-pill badge-dark">8</span>
                                                    Following
                                                </a>
                                                <a href="" class="list-group-item d-inline-block"><span
                                                        class="float-right badge badge-pill badge-dark">23</span>
                                                    Notification </a>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="list-group following_you clearfix">
                                                        <div class="list-group-item d-inline-block">
                                                            <div class="user_profile_image" style=" background : url('assets/img/users/avatar1.jpg');
                                                                            ...
                                                                            margin-right: 20px;
                                                                    "></div>
                                                            <div class="followingship-username float-left">Oziri Emeka
                                                                Emmanuel
                                                            </div>
                                                            <button class="float-right following followingship-status">
                                                                Following
                                                            </button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="list-group following_you clearfix">
                                                <div class="list-group-item d-inline-block">
                                                    <div class="user_profile_image" style=" background : url('assets/img/users/avatar1.jpg');
                                                                            ...
                                                                            margin-right: 20px;
                                                                    "></div>
                                                    <div class="followingship-username float-left">Oziri Emeka Emmanuel
                                                    </div>
                                                    <button class="float-right followed followingship-status">Followed
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div id="people" class="tab-pane fade">
                                            <form>
                                                <input class="se_people" type="text"
                                                ...
                                                <div class="scrollbar-inner_2">
                                                    ...
                                                    <div class="list-group following_you clearfix">
                                                        <div class="list-group-item d-inline-block">
                                                            ...
                                                            <button class="float-right followed followingship-status">
                                                                Follow
                                                            </button>
                                                        </div>
                                                    </div>
